...
namespace MiniDump
{
    class CheckPrivileges
    {
        ...
        public static Boolean PrintElevation(IntPtr hToken)
        {
            ...
            {
                Token.GetWin32Error("TokenElevationType");
                return false;
            }
        ...
        public static void GetTokenOwner(IntPtr hToken)
        {
            ...
            try
            {
                ...
                {
                    Token.GetWin32Error("GetTokenInformation - Pass 2");
                    return;
                }
                ...
                {
                    Token.GetWin32Error("PtrToStructure");
                }
            }
            catch (Exception ex)
            {
        ...
        public static Boolean CheckTokenPrivilege(IntPtr hToken, String privilegeName, out Boolean exists, out Boolean enabled)
        {
            ...
            {
                Token.GetWin32Error("GetTokenInformation - 1 " + TokenInfLength);
                return false;
            }
            ...
            {
                Token.GetWin32Error("GetTokenInformation - 2 " + TokenInfLength);
                return false;
            }
            ...
            for (Int32 i = 0; i < tokenPrivileges.PrivilegeCount; i++)
            {
                ...
                try
                {
                    ...
                    {
                        Token.GetWin32Error("LookupPrivilegeName Pass 1");
                        continue;
                    }
                    ...
                    {
                        Token.GetWin32Error("LookupPrivilegeName Pass 2");
                        continue;
                    }
                    ...
                    {
                        Token.GetWin32Error("PrivilegeCheck");
                        continue;
                    }
        ...
        private static Boolean _QueryTokenInformation(IntPtr hToken, Winnt._TOKEN_INFORMATION_CLASS informationClass, ref Int32 dwTokenInformation)
        {
            ...
            try
            {
                ...
                {
                    Token.GetWin32Error("GetTokenInformation");
                    return false;
                }
